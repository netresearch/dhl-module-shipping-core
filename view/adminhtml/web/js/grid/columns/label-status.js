...
define([
    ...
    return Element.extend({
        ...
        getPendingIconUrl: function () {
            return require.toUrl('Dhl_ShippingCore/images/icon_incomplete.png');
        },
        ...
        getProcessedIconUrl: function () {
            return require.toUrl('Dhl_ShippingCore/images/icon_complete.png');
        },
        ...
        getFailedIconUrl: function () {
            return require.toUrl('Dhl_ShippingCore/images/icon_failed.png');
        }
    });
});
